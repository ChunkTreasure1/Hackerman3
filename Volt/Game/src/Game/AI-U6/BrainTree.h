...
namespace BrainTree
{
	...
	public:
		...
		virtual void initialize(Volt::Entity aEntity) {}
	...
	public:
		...
		void setEntity(Volt::Entity aEntity) { entity = aEntity; }
		Volt::Entity getEntity() { return entity; }
	...
	private:
		...
		Blackboard::Ptr blackboard = nullptr;
		Volt::Entity myEntity = Volt::Entity{ 0,nullptr };
	};
