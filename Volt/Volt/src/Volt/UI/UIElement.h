...
public:
	...
	void SetCanvas(Ref<UICanvas> aCanvas) { myCanvas = aCanvas; SetChildCanvas(myCanvas); }
	Ref<UICanvas>& GetCanvas() { return myCanvas; }
	void SetChildCanvas(Ref<UICanvas> aCanvas) 
	{
		for (auto child : myChildren)
		{
