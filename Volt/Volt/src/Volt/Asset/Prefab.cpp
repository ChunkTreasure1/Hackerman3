...
namespace Volt
{
	...
	Wire::EntityId Prefab::InstantiateEntity(Wire::Registry& aTargetRegistry, Wire::EntityId prefabEntity, Wire::EntityId parentEntity)
	{
		...
		Entity::Copy(myRegistry, aTargetRegistry, prefabEntity, newEntity);
	...
	void Prefab::OverrideEntity(Wire::Registry& aSrcRegistry, Wire::EntityId aSrcEntity)
	{
		...
		auto& targetTransComp = myRegistry.GetComponent<TransformComponent>(srcPrefabComp.prefabEntity);
		auto& srcTransComp = aSrcRegistry.GetComponent<TransformComponent>(aSrcEntity);
