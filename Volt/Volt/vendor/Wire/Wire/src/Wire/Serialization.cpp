			...
			// Handle property options
			{
				...
				// Find property name and get it's offset
				{
					...
					if (propertySpecialType == "enum")
					{
						...
						const size_t firstLetter = propertyString.find_first_of("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", propertyEnd);
						const size_t lastLetter = propertyString.find_first_not_of("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", firstLetter);
